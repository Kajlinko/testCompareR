compbdt <- function(s11, s10, s01, s00, r11, r10, r01, r00, alpha = 0.05)
{
  ...
  cat("\n")
  cat("Estimated prevalence of the disease is ",round(100 * prev, decip),"% and its standard error is", round(100 * sqrt(Varprev), decip), "\n")
  cat("\n")
  ...
  cat("\n")
  cat("Estimated sensitivity of Test 1 is ",round(100 * Se1, decip),"% and its standard error is", round(100 * sqrt(VarSe1), decip), "\n")
  cat("\n")
  cat(100 * conf,"% confidence interval for the sensitivity of Test 1 is (", round(100 * max(0, LSe1), decip),"% ; ", round(100 * min(USe1, 1), decip),"%) \n")
  cat("\n")
  cat("Estimated sensitivity of Test 2 is ",round(100 * Se2, decip),"% and its standard error is", round(100 * sqrt(VarSe2), decip), "\n")
  cat("\n")
  cat(100 * conf,"% confidence interval for the sensitivity of Test 1 is (", round(100 * max(0, LSe2), decip),"% ; ", round(100 * min(USe2, 1), decip),"%) \n")
  cat("\n")
  cat("Estimated specificity of Test 1 is ",round(100 * Sp1, decip),"% and its standard error is", round(100 * sqrt(VarSp1), decip), "\n")
  cat("\n")
  cat(100 * conf,"% confidence interval for the specificity of Test 1 is (", round(100 * max(0, LSp1), decip),"% ; ", round(100 * min(USp1, 1), decip),"%) \n")
  cat("\n")
  cat("Estimated specificity of Test 2 is ",round(100 * Sp2, decip),"% and its standard error is", round(100 * sqrt(VarSp2), decip), "\n")
  cat("\n")
  ...
  cat("\n")
  cat("Estimated positive PV of Test 1 is ", round(100 * PPV1, decip),"% and its standard error is", round(100 * sqrt(Var[1, 1]), decip), "\n")
  cat("\n")
  ...
  cat("\n")
  cat("Estimated positive PV of Test 2 is ", round(100 * PPV2, decip),"% and its standard error is", round(100 * sqrt(Var[2, 2]), decip), "\n")
  cat("\n")
  ...
  cat("\n")
  cat("Estimated negative PV of Test 1 is ",round(100 * NPV1, decip),"% and its standard error is", round(100 * sqrt(Var[3, 3]), decip), "\n")
  cat("\n")
  ...
  cat("\n")
  cat("Estimated negative PV of Test 2 is ",round(100 * NPV2, decip),"% and its standard error is", round(100 * sqrt(Var[4, 4]), decip), "\n")
  cat("\n")
