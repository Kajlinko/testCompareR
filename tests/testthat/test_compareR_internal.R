...
test_that("conf.acc function tests", {
  ...
  expect_equal(output1$test1.se$ci.lower, 0.713951, tolerance = 1e-06)
  expect_equal(output1$test1.se$ci.upper, 0.7830987, tolerance = 1e-06)
  ...
  expect_equal(output1$test2.se$ci.lower, 0.662247, tolerance = 1e-06)
  expect_equal(output1$test2.se$ci.upper, 0.7353928, tolerance = 1e-06)
  ...
  expect_equal(output1$test1.sp$ci.lower, 0.6880295, tolerance = 1e-06)
  expect_equal(output1$test1.sp$ci.upper, 0.7593152, tolerance = 1e-06)
  ...
  expect_equal(output1$test2.sp$ci.lower, 0.7400249, tolerance = 1e-06)
  expect_equal(output1$test2.sp$ci.upper, 0.8067297, tolerance = 1e-06)
  ...
  expect_equal(output2$test1.se$ci.lower, 0.7199015, tolerance = 1e-06)
  expect_equal(output2$test1.se$ci.upper, 0.7779686, tolerance = 1e-06)
  ...
  expect_equal(output2$test2.se$ci.lower, 0.6684317, tolerance = 1e-06)
  expect_equal(output2$test2.se$ci.upper, 0.7298644, tolerance = 1e-06)
  ...
  expect_equal(output2$test1.sp$ci.lower, 0.694108, tolerance = 1e-06)
  expect_equal(output2$test1.sp$ci.upper, 0.753975, tolerance = 1e-06)
  ...
  expect_equal(output2$test2.sp$ci.lower, 0.7458233, tolerance = 1e-06)
  expect_equal(output2$test2.sp$ci.upper, 0.8018338, tolerance = 1e-06)
...
test_that("conf.pv function tests", {
  ...
  expect_equal(output1$test1.ppv$SE, 0.000784014, tolerance = 1e-06)
  expect_equal(output1$test1.ppv$ci.lower, 0.8020161, tolerance = 1e-06)
  expect_equal(output1$test1.ppv$ci.upper, 0.880647, tolerance = 1e-06)
  ...
  expect_equal(output1$test2.ppv$SE, 0.0007821402, tolerance = 1e-06)
  expect_equal(output1$test2.ppv$ci.lower, 0.7000829, tolerance = 1e-06)
  expect_equal(output1$test2.ppv$ci.upper, 0.9468642, tolerance = 1e-06)
  ...
  expect_equal(output1$test1.npv$SE, 0.0007821402, tolerance = 1e-06)
  ...
  expect_equal(output1$test2.npv$SE, 0.001220905, tolerance = 1e-06)
  ...
  expect_equal(output2$test1.ppv$SE, 0.000784014, tolerance = 1e-06)
  expect_equal(output2$test1.ppv$ci.lower, 0.8093662, tolerance = 1e-06)
  expect_equal(output2$test1.ppv$ci.upper, 0.8753677, tolerance = 1e-06)
  ...
  expect_equal(output2$test2.ppv$SE, 0.0007821402, tolerance = 1e-06)
  expect_equal(output2$test2.ppv$ci.lower, 0.7294139, tolerance = 1e-06)
  expect_equal(output2$test2.ppv$ci.upper, 0.9369005, tolerance = 1e-06)
  ...
  expect_equal(output2$test1.npv$SE, 0.0007821402, tolerance = 1e-06)
  ...
  expect_equal(output2$test2.npv$SE, 0.001220905, tolerance = 1e-06)
